...
import com.dazf.frame.commonutils.CharacterHandler;
import com.dazf.frame.commonutils.ZipHelper;
...
public class RequestInterceptor implements Interceptor {
    ...
    public Response intercept(Chain chain) throws IOException {
        ...
        if (logRequest) {
            ...
            //打印请求信息
            Timber.tag(getTag(request, "Request_Info")).w("%nParams : 「 %s 」%nConnection : 「 %s 」%nHeaders : %n「 %s 」"
        ...
        if (logResponse) {
            ...
            //打印响应时间以及响应头
            Timber.tag(getTag(request, "Response_Info")).w("%nReceived response in [ %d-ms ] , [ %s ]%n%s"
